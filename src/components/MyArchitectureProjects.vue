<template>
    <div class="w-full flex flex-col gap-8 mx-auto">
        ...
        <ul class="w-full grid sm:grid-cols-3 grid-cols-1 gap-2 bg-gray-200 p-4 rounded-md shadow-md">
            <archi-project-card
        ...
        <dialog :open="showDialog" class="max-w-6xl bg-gray-200 bg-opacity-50 backdrop-filter backdrop-blur-md">
            ...
            <div class="w-full grid sm:grid-cols-2 grid-cols-1 gap-4 mt-2 clear-both">
